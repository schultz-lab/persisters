...
P_0 = N_0 * (init_pers_perc_1000x/100);
...
elseif drug == "Cip"
    ylim([0,4*10^-3]);
    yticks(0:10^-3:4*10^-3);
elseif drug == "Kan"
    ylim([0,1.2*10^-5]);
    yticks(0:0.2*10^-5:1.2*10^-5);
end
...
% Save plot
fig1_plot_name = strcat(drug,"_MeanParamTimeKillPersisterDynamics_Zoomed.png");

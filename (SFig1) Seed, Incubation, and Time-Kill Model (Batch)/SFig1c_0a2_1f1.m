...
a_2 = 0*1.2*10^-6*(1/60); % Per cell per hour times (1h / 60min), Given in Balaban Fig 2
...
f_1 = 0.00138*(1/60); % drug induction of persistence per cell per hour times (1h / 60min)
...
legend('S','P_1','','P_{tot}','N');

title('a_2 = 0   &   f_1 = This Study');

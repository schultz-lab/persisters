...
load("t_Amp_exper.mat");
load("y_Amp_exper.mat");
load("SD_Amp_exper.mat");
...
plot(t_Amp_sim,y_Amp_sim,'Color',drug_colors(1,:),'LineStyle','-','LineWidth',3);
...
scatter(t_Amp_exper,y_Amp_exper,point_size,'filled','MarkerEdgeColor','k','MarkerFaceColor',drug_colors(1,:),'LineWidth',1,'MarkerFaceAlpha',0.75,'MarkerEdgeAlpha',0.75);
...
errorbar(t_Amp_exper,y_Amp_exper,SD_Amp_exper,'color','k','LineWidth',1,'LineStyle','none','CapSize',12);
...
% Save plot
saveas(f12,"CipAmpPBS_Combined.png");
...
text(0.05, 10^-0.65, "P_0","Color",colors_RGB(1,:),'FontSize',22,'FontWeight','bold');
text(0.05, 10^-1.65, "P_0","Color",colors_RGB(2,:),'FontSize',22,'FontWeight','bold');
text(0.05, 10^-2.65, "P_0","Color",colors_RGB(3,:),'FontSize',22,'FontWeight','bold');
...
xlim([0,6]);
xticks(0:1:6);
% title({"Pre-Existence Model","Seed Culture Dilution"});
...
% Save Figure
saveas(f1,"Intro_to_Model_SDTK_f1_equals_0.png");
